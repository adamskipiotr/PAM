...
class StudentMessages : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        call.enqueue(object : Callback<List<MessageDTO>> {
            ...
            override fun onResponse(
                ...
                populateStudentsHistoryList(response, studentApi, studentTemp)
            }
        })
    }

    private fun populateStudentsHistoryList(
        response: Response<List<MessageDTO>>,
        studentApi: StudentApi,
        studentTemp: StudentDTO
    ) {
            ...
            AdapterView.OnItemClickListener { parent, view, position, id ->
                ...
                MaterialAlertDialogBuilder(context).apply {
                    ...
                    setPositiveButton("Potwierdź") { _, _ ->
                        ...
                        confirmMessageRead(studentApi, studentTemp, messageToDelete)
    ...
    private fun confirmMessageRead(
        studentApi: StudentApi,
        studentTemp: StudentDTO,
        messageToDelete: MessageDTO
    ) {
        val call: Call<Void> =
            studentApi.markMessageAsSeen(studentTemp.getStudentID(), messageToDelete)
        call.enqueue(object : Callback<Void> {
            ...
            override fun onResponse(
                ...
                Toast.makeText(applicationContext, "Oznaczono jako przeczytana", Toast.LENGTH_LONG)
                    .show()
            }
        })
    }
